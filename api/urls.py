...
apipatterns = [
    ...
    path("subscriptions", views.ApiSubscribe.as_view(), name="add_to_subscribe"),
    path("subscriptions/<int:pk>", views.ApiSubscribe.as_view(), name="remove_from_subscribe"),
    path("purchases", views.ApiPurchase.as_view(), name="add_to_purchase"),
    path("purchases/<int:pk>", views.ApiPurchase.as_view(), name="remove_from_purchase"),
]
